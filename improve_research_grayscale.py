...
def train_and_evaluate(dataset_name):
    ...
    Args:
        dataset_name (str): The name of the dataset to use ('mnist' or 'fashion_mnist').
    """
    ...
    if dataset_name == 'mnist':
        ...
        raise ValueError("Dataset not supported. Choose 'mnist' or 'fashion_mnist'.")
    ...
    # Reshape images to (28, 28, 1) to include the channel dimension
